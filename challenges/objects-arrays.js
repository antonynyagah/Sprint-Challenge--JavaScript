...
zooAnimals.forEach(function(animal)
{
	...
	const name = animal.animal_name +" "+ animal.scientific_name;
...
zooAnimals.map(function(firstname)
{
	...
	const name = firstname.animal_name;
...
const filterlargerpopulation = zooAnimals.filter((animal) => {
  return animal.population < 5;
});

largerPopulation.push(filterlargerpopulation)
...
let populationreduce = populationTotal.reduce((total,element)=>{
